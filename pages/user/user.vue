		...
		<view class="user_login">
			<view class="user_login_any">
				<view class="user_login_msg">
					...
					<view class="user_title" v-else @click="addInfo">
						<view class="nickname">
							{{ userInfo.nick_name }}
						</view>
						<view class="tokens">
					...
					<view v-if="userInfo.role!='guess'">
						<view class="NoReaName" v-if="userInfo.is_real_name==1" @click="toH5Link">实名认证</view>
		...
		<view class="cont_user">
			<view class="cont_ul">
				...
				<view class="user_icon">
					...
					<view class="icon_list" @click="copyFun('https://ai.umi6.com/h5/#/')">
						<image class="icon_img" :src='h5Img' />
						<text class="icon_title">H5链接</text>
					</view>
					<view class="icon_list" @click="copyFun('https://ai.umi6.com/#/')">
			...
			<view class="cont_ul">
				...
				<view class="user_icon">
					...
					<view class="icon_list" @click="checkQuest">
						...
						<text class="icon_title">投诉及建议</text>
					</view>
			...
			<view class="cont_ul">
				...
				<view class="user_icon">
					<view class="icon_list" @click="buyVip">
						...
						<text class="icon_title">AI商城</text>
					</view>
...
<script>
	...
	export default {
		...
		onShow() {
			...
			this.getQrCode()
			this.getCompanyList()
			if (uni.getStorageSync('openKey') == 666) {
				this.openKey()
				uni.setStorageSync('openKey', '')
			}

			if (uni.getStorageSync('userInfo') != '') {
				// console.log(uni.getStorageSync('userInfo'),2234);
