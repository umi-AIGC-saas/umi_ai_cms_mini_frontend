<template>
	<view style="background-color: #FEFEFE;height: 100vh;">
		...
		<view class="tips">
			<text class="tip_m">Tips:对图像进行统一修改风格，包括向日葵、垦丁、大理等效果，对图像整体风格调整滤镜效果。</text>
		</view>
		<view class="bottom">
		...
		<view class="footer">
			<view class="text">本次生成将消耗45w算力/次</view>
				...
				uni.chooseMedia({
					...
					success(res) {
						...
						that.$nextTick(() => {
							uni.getImageInfo({
								...
								success: (res) => {
									...
									if (width < 32 || width > 2000 || height < 32 ||
										height >
										2000)
										that.$api.msg('请上传大于32*32像素，小于2000*2000像素的图片')
									return
								}
							})
						})
						if (fileExtension === 'jpg' || fileExtension === 'jpeg' ||
							...
							that.$api.msg('只允许上传 .jpg、.jpeg、.png、.bmp 格式的图片')
							return
						}
					}
				})
