<template>
	<view>
		...
		<view class="chat_cont" style="margin-top: 220upx;">
						...
						<view class="ul_right">
							<view class="li_top">
								...
								<image style="width: 48upx;height: 48upx;" :src="delImg"
									@click.stop="delPhoto(item.session_code)"></image>
							</view>
							<!-- <view class="li_btn">
							...
							<view class="li_edit">
								...
								<!-- <view class="edit_l" @click.stop="delPhoto(item.session_code)">播放</view>
								<view class="edit_l" @click.stop="delPhoto(item.session_code)">下载</view> -->
...
<script>
	...
	export default {
		...
		methods: {
			...
			checkDetail(code) {
				uni.navigateTo({
					url: '/childPage/voice/speak_detail?session_code=' + code
				})
			},
