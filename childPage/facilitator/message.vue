<template>
	<view style='padding: 30upx;'>
		<view style="padding: 40upx;width: calc(100% - 60upx);background-color: #fff; border-radius: 10upx;">
			<u-form ref='uForm'>
				<u-form-item label-width='120upx' label="姓名" prop="name" label-position="top" required='true'>
					<u-input v-model="name" placeholder="请输入您的姓名" />
				</u-form-item>
				<u-form-item label-width='120upx' label="手机号码" prop="mobile" label-position="top" required='true'>
					<u-input v-model="mobile" placeholder="请输入您的手机号码" />
				</u-form-item>
				<u-form-item label-width='120upx' label="合作意向" label-position="top">
