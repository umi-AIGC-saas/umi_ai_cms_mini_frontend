<template>
	<view style="padding: 32upx;">
		<view style="padding: 32upx;background-color: #fff;height: 1400upx;">
			<view class="top">
				<view class="nav" v-if="level != 3">升级服务商，您将尊享以下更多权益</view>
				<view class="nav" v-else>您好服务商，您将尊享以下更多权益</view>
				<view class="btn_top" @click="toMessage" v-if="level != 3">申请服务商</view>
			...
			<view class="main">
				<view class="item" v-for="(item,index) in list" :key="index">
					...
					<view class="main_text">{{ item.content }}</view>
					<!-- <ua-markdown style="color: #666;line-height: 42upx;" :source="item.content" :showLine="false" /> -->
				</view>
			</view>
			<view class='btn' @click="toMessage" v-if="level != 3">申请服务商</view>
		</view>
	</view>
</template>
