		...
		<view class="cont">
			...
			<view class="cont_top">
				<div class="top">
					...
					<view v-if="level_expire_time" style="color: #fff;font-size: 22rpx;margin-right: 210rpx;">到期时间：{{level_expire_time}}</view>
			...
			<view class="popup_cont">
				...
				<view style="padding: 0 15upx;">
					...
					<view class="cont_text" style="background: rgba(255, 158, 75, 0.1);">
						<view class="cont_slove" style="background: linear-gradient(180deg, #FFC869 0%, #FF9545 100%); color: #fff;">普通分销</view>
						<view class="slove_text">注册完成后即为普通分销，享受利润分佣。成为普通分销后，且成功邀请1位新人注册成为我的成员后，可享受成员充值分佣，您的成员充值您都将获得15%佣金。</view>
					</view>
					
					<view class="cont_text" style="background: #FFF9E6;">
						<view class="cont_slove" style="background: linear-gradient(138.05deg, #FBE363 0.23%, #FEBF37 99.7%);; color: #fff;">金牌分销</view>
						<view class="slove_text">充值99元您将升级成为金牌分销，佣金由15%提升到30%，享有更高佣金福利。</view>
					</view>
...
<script>
	...
	export default {
		...
		onShow() {
			...
			this.level_expire_time=uni.getStorageSync('level_expire_time')
