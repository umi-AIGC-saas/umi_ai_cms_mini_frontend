			...
			<view class="cash">
				...
				<view class="cash_price">
					...
					<u-input :customStyle='{"background":"#fff","padding":"8px"}' fontSize="16" v-model="price"
						border="none" placeholder="请输入提现金额" type="number" @blur="priceChange"></u-input>
				</view>
				<view class="cash_tip">
					<view class="tip_l">
					...
					<view class="tip_r" @click.stop="allPrice">全部提现</view>
				</view>
			</view>

		</view>
		<view style="font-size: 24rpx;font-weight: 600;margin-bottom: 20rpx;">或者，您也可以选择将佣金兑换成通用算力</view>
...
<script>
	...
	export default {
		...
		methods: {
			...
			toBank() {
				uni.navigateTo({
					url: '/childPage/distribution/bank',
				})
				this.bankShow = false;
			},
			//全部提现
